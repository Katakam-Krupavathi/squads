...
export const DEMO_REPOSITORIES: RepositoryAnalysis[] = [
  {
    id: "chalk-chalk",
        ...
        difficulty: {
          ...
          signals: {
            "blast_radius": {
              ...
              weight: 0.22,
              weighted_score: 3.96,
              evidence: ["Single file targeted: `source/index.js`", "Modifies localized CLI color formatting helper"],
        ...
        difficulty: {
          ...
          signals: {
            ...
            "specification_quality": {
              ...
              weight: 0.16,
              weighted_score: 10.4,
              evidence: ["Brief description without reproduction logs", "No stack trace or reproduction commands"],
